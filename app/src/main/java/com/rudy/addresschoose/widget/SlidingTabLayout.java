package com.rudy.addresschoose.widget;
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorHeight > 0) {
               ...
               /* mRectPaint.setColor(mIndicatorColor);
                calcIndicatorRect();
                canvas.drawRect(getPaddingLeft() + mIndicatorRect.left, getScreenHeight() - mIndicatorHeight,
                        mIndicatorRect.right + getPaddingLeft(), getScreenHeight(), mRectPaint);*/
